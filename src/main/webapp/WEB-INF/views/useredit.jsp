...
<h3>Update User Account</h3>
  <div class="jumbotron">
        ...
        <form action="/myapp/updateuser.htm" method="post">
          <div class="form-group">
          
          	<div class="form-group">
             User Id: <input type="text" name="userid" class="form-control" value="${user.getId()}" readonly="readonly" >
             </div>
          
          	<div class="form-group">
             User Name      <input type="text" name="username" class="form-control" placeholder="Enter User Name" value="${user.getName()}" required>
             </div>
             
             
            <div class="form-group">
             User Email:     <input type="email" name="email" class="form-control" placeholder="Enter Email Id" value = "${user.getEmail()}" required> 
